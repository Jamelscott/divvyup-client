...
function FriendsList({ sourceType }: { sourceType: FriendSourceType }) {
  ...
  return (
    <>
      <>
        <div
          className="flex flex-col items-center gap-5 bg-white rounded-3xl border-black border p-2.5 shadow-lg w-full overflow-y-scroll"
          style={{ height: "100%" }}
        >
          <h2>
            <b>Friends</b>
          ...
          <div
            className="h-full overflow-y-scroll w-full p-5"
