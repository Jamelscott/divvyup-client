...
const LoginForm = ({open, setIsLoggingIn, setOpenLogin, mobile}:{open:boolean,setOpenLogin: (val:boolean) => void , setIsLoggingIn: (val:boolean) => void, mobile:boolean}) => {
    ...
    const canSubmit = !!loginCreds.usernameOrEmail.charAt(3) && !!loginCreds.password.charAt(4)
    return (
        <form
            style={{ 
        ...
        >
                ...
                <div className='w-[100%]'>
                    <TextInput color="white" label='Username or Email' size="md"
                ...
                <Button disabled={!canSubmit} className="mt-2" radius="xs" size="sm" variant="default" color="grey" type="submit">
                    Submit
                </Button>
            </div>
            </form>
